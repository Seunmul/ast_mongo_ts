...
export class StaticModelHelper {
  ...
  constructor(
    ...
    categorymetricId: string | ObjectId,
    cbs?: StaticModelHelperCB
  ) {
  ...
  async create(...args: any[]): Promise<any> {
          ...
          return this.create([
            {
              ...
              category: args[1] as string,
              configs: args[2] as Configs[],
            },
          ]);
    ...
    for (const sc of staticConfigs) {
      ...
      if (aVar) {
        ...
        const metric = await this._model.findOneAndUpdate(
          filter,
          {
